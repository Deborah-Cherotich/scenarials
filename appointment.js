...
this.date = date;
this.time = time; } }
let appointments = new AppointmentScheduling("Dr. James", "cardiologist");
appointments.addAvailability("2024-05-10", ["09:00", "10:00", "12:00"]);
const patients = new Patient("Sharon Wanjiku", "wanjikusharon.com", "34-24-89-66");
patients.setPreferences(appointments, "2024-06-15", "07:00");
appointments.scheduleAppointment(patients, "2024-06-15", "07:00");